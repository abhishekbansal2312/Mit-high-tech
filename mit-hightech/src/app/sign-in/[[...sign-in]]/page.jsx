      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <motion.h1
            ...
            className="text-2xl md:text-3xl font-bold text-black text-center tracking-wide"
          >
            Welcome Back
          </motion.h1>
          <motion.div
            ...
            <SignIn 
              appearance={{
                elements: {
                  ...
                  formButtonPrimary: 
                    "bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-black font-medium py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-indigo-500/30",
        ...
        <motion.div
          ...
          className="absolute -z-10 w-80 h-80 rounded-full bg-blue-500/20 blur-[100px] -top-20 -right-20"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1, duration: 1 }}
          className="absolute -z-10 w-80 h-80 rounded-full bg-purple-500/20 blur-[100px] -bottom-40 -left-20"
        />
      </motion.div>
